...
Vale un analogo teorema di linearizzazione per i sistemi a tempo discreto.
...
\end{equation*}
C'è un problema, affinché $y(t)\to \overline{y}$ serve che $G(s)$ sia asintoticamente stabile, ma la $G(s)$ reale è in generale diversa dalla $\tilde{G}(s)$ approssimata del modello. Quindi usiamo sistemi in \textbf{retroazione}.
...
\begin{equation}\label{formula-errore-sinusoidale}
...
Una nota importante: se il disturbo è \textbf{somma di uno sinusoidale e uno costante} lo si tratta come sinusoidale e la parte a costante si considera con $\omega =0$ nella formula \eqref{formula-errore-sinusoidale}.
